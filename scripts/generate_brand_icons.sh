...
# Splash / native splash image (mark on field, no need for huge rules at 288+)
render "$MASTER" 288 "$OUT/splash/splash.png"
render "$MASTER" 1152 "$OUT/splash/splash-android12.png"
